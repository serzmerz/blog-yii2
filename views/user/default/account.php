...
$notificationTypes = \app\models\NotificationTypes::find()->all();

$notificationTypesArray = [];
foreach ($notificationTypes as $item){
    $notificationTypesArray[$item->id] = $item->title;
}
...
<div class="user-default-account">
    ...
    <?= $form->field($user, 'notification_id')->dropDownList($notificationTypesArray); ?>
